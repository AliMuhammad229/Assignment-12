...
//Q: 06 Make use of alerts in your new/existing HTML & CSS project.
window.alert("Hello World!");




//Q: 06 Practice placement of <script></script> element in following sections of your project in exercise 6:
// a. Head
...
//Q: 01. Declare a variable called username.
var username;



//Q: 02. Declare a variable called myName & assign to it a string that represents your Full Name.
var myName = "Ali Muhammad";




//Q: 03. Write script to
...
//Q: 04. Write a script to save student’s bio data in JS variables and show the data in alert boxes.
var name = "Ali Muhammad";
var age = 21;
...
//Q: 05. Write a script to display the following alert using one JS variable:
var pizza = "PIZZA\nPIZZ\nPIZ\nPI\nP";
alert(pizza);
...
//Q: 06. Declare a variable called email and assign to it a string that represents your Email Address(e.g. example@example.com).
...
//Q: 07. Declare a variable called book & give it the value “A smarter way to learn JavaScript”.
...
//Q: 08. Write a script to display this in browser through JS
...
//Q: 09. Store following string in a variable and show in alert and browser through JS “▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬”
var symbol = "“▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬”";
alert(symbol);
...
//Q: 01. Declare a variable called age & assign to it your age. Show your age in an alert box.
var age = 21;
alert("I am " + age + " years old");



//Q: 02. Declare & initialize a variable to keep track of how many times a visitor has visited a web page. Show his/her
...
//Q: 03. Declare a variable called birthYear & assign to it your birth year. Show the following message in your browser:
var birthYear = 1996;
...
//Q: 04. A visitor visits an online clothing store www.xyzClothing.com . Write a script to store in variables the following information:
// a. Visitor’s name
// b. Product title
...
//Q: 01. Declare 3 variables in one statement
var name, age, gender;




//Q: 02. Declare 5 legal & 5 illegal variable names.
//Legal Variable
var name;
var birthYear;
var $year;
...
//Q: 03. Display this in your browser
...
//Q: 01. Write a program that take two numbers & add them in a new variable. Show the result in your browser.
...
//Q: 04. Cost of one movie ticket is 600 PKR. Write a script to store ticket price in a variable &
...
//Q: 05. Write a script to display multiplication table of any number in your browser. E.g
var tableNumber = 5;
var i = 0;
...
//Q: 07. Write a program to implement checkout process of a shopping cart system for an e-commerce website. Store
...
//Q: 01. Write a program to take a number in a variable, do the required arithmetic to display the following result in your browser:
...
//Q: 02. What will be the output in variables a, b & result after execution of the following script:
// var a = 2, b = 1;
// var result = --a - --b + ++b + b--;
...
//Q: 03. Write a program that takes input a name from user & greet the user.
...
//Q: 05. Write a program to take input a number from user & display it’s multiplication table on your browser. If user
...
//Q: 01. Write a program to take “city” name as input from user. If user enters “Karachi”,
...
//Q: 02. Write a program to take “gender” as input from user. If the user is male, give the message:
...
//Q: 03. Write a program to take input color of road traffic signal from the user & show the message according to this table:
...
//Q: 04. Write a program to take input remaining fuel in car (in litres) from user. If the current fuel is less than 0.25litres, show the message “Please refill the fuel in your car”
...
//Q: 05. Run this script, & check whether alert message would be displayed or not. Record the outputs.
// Part A
var a = 4;
if (++a === 5) {
...
//Q: 06. Write a program to take input the marks obtained in three subjects & total marks. Compute & show the resulting
...
//Q: 08. Write a program to check whether the given number is divisible by 3. Show the message to the
...
//Q: 09. Write a program that checks whether the given input is an even number or an odd number.
...
//Q: 01. Write a program that takes a character (number or string) in a variable & checks whether the given input is a
...
//Q: 02. Write a JavaScript program that accept two integers and display the larger. Also show if the two integers are equal.
var firstNumber = +prompt("Enter First Number: ");
var secondNumber = +prompt("Enter Second Number: ");
...
//Q: 03. Write a program that takes input a number from user & state whether the number is positive, negative or zero.
...
//Q: 04. Write a program that takes a character (i.e. string of length 1) and returns true if it is a vowel, false otherwise
...
//Q: 06. This if/else statement does not work. Try to fix it:
// var greeting;
// var hour = 13;
// if (hour < 18) {
// greeting = "Good day";
...
//Q: 07. Write a program that takes time as input from user in 24 hours clock format like: 1900 = 7pm.
...
//Q: 01. Declare an empty array using JS literal notation to store student names in future. 
var students = [];




//Q: 02. Declare an empty array using JS object notation to store student names in future. 
...
//Q: 03. Declare and initialize a strings array.
...
//Q: 04.  Declare and initialize a numbers array. 
...
//Q: 05.  Declare and initialize a boolean array. 
...
//Q: 06. Declare and initialize a mixed array. 
...
//Q: 07. Declare and Initialize an array and store available education qualifications in Pakistan (e.g. SSC, HSC, BCS, BS, BCOM, MS, M. Phil., PhD).
...
//Q: 08. Write a program to store 3 student names in an array.Take another array to store score of these three students.
...
//Q: 09. Initialize an array with color names. Display the array elements in your browser.
var colorNames = [];
...
//Q: 12. Write a program to create a single string from the below mentioned array: var arr = [“This ”, “ is ”, “ my ”, “ cat”];
...
//Q: 01. Declare and initialize an empty multidimensional array.(Array of arrays)
var arr = [];



//Q: 02. Declare and initialize a multidimensional array representing the following matrix:
var arr = [
    [0, 1, 2, 3],
    [1, 0, 1, 2],
    [2, 1, 0, 1]
...
//Q: 03. Write a program to print numeric counting from 1 to 10.
for (i = 1; i <= 10; i++) {
    document.write(i + "<br>");
}
...
//Q: 04. Write a program to print multiplication table of any number using for loop.
...
//Q: 05. Write a program to print items of the following array using for loop:
...
//Q: 06. Generate the following series in your browser. See example output.
...
//Q: 08. Write a program to identify the largest number in the given array.
// A = [24, 53, 78, 91, 12].
...
//Q: 09. Write a program to identify the smallest number in the given array.
// A = [24, 53, 78, 91, 12]
var arr = [24, 53, 78, 91, 12];
